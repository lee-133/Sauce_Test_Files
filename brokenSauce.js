...
describe('Broken Sauce', function () {
    it('should go to Google and click Sauce', async function () {
        ...
        let page = await driver.findElement(By.partialLinkText("Sauce Labs"));
        await page.click();

        let resources = await driver.findElement(By.xpath("//span[text()='Resources']"));
        await driver.actions({ bridge: true }).move({ origin: resources }).perform();
